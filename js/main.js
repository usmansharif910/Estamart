...
window.addEventListener("DOMContentLoaded", () => {
  const img = document.querySelector(".feature-2-img");
  const content = document.querySelector(".feature-2-contents");
...
// Check if the section is in view on page load
animateIfVisible();

// Check if the section is in view when scrolling
